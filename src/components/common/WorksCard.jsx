const WorksCard = (props) => {
    return (
        ...
        >
            <div
                className="sm:mb-7 mb-5 sm:w-[85px] sm:h-[85px] w-[75px] duration-300 h-[75px] rounded-[7px] shadow-[0px_10px_20px_0px_#4B17E62B] hover:shadow-[0_11.57px_23.15px_0_#05D5FB29] transition-all ease-linear flex justify-center items-center "
            >
                {props.worksvg}
            </div>
