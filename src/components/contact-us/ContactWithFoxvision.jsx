...
//         }
//         if (!formData.box) {
//             errors.box = "Please fill this out.";
//         }
...
//                                 <textarea required className="resize-none text-base !text-black h-[100px] sm:h-[159px] placeholder:text-black placeholder:!text-opacity-50 !text-opacity-50 font-poppins font-normal p-3 sm:p-[15px] outline-none w-full border-solid border border-lightBlue shadow-[0px_0px_5px_-2px_#4B17E666]"
//                                     type="text"
...
//                             </div>
//                             {formErrors.box && (
//                                 <p className="error-message font-poppins mt-[-5px] ">{formErrors.box}</p>
//                             )}
...
//                                             className='sm:py-[14px] py-3 sm:px-[50px] px-7 bg-sky hover:bg-darkpurple transition-all duration-300 ease-in-out  rounded-[69px] text-white font-semibold sm:text-base text-sm leading-normal'
//                                         >
//                                            close
//                                         </button>
//                                     </div>
...
const ContactWithFoxvision = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.box) {
            errors.box = "Please agree to terms.";
        }
