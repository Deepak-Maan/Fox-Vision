            ...
            <div className="container md:max-w-[768px] lg:max-w-[1164px] px-3 lg:px-4 xl:px-3 mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-5  md:mt-10 lg:mt-[70px] xl:mt-[88px] gap-[30px]">
                    {reachOutData.map((data, index) => (
                        <Link to={data.link} target={data.target} rel='noreferrer' key={index} className={`min-[425px]:max-w-[360px] sm:max-w-[80%] mx-auto w-full max-h-[265px] group hover:translate-y-[-12px] lg:hover:translate-y-[-38px] duration-300 shadow-[0_4px_27px_0_#4B17E614] ${index === 0 ? "sm:py-10 py-4 " : index === 1 ? "sm:py-10 py-4 " : index === 2 ? "sm:py-7  py-4 sm:col-span-2 lg:col-span-1 " : ""} `} >
