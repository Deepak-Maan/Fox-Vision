            ...
            <div className='max-w-[1164px] mx-auto px-3'>
                <div className='lg:flex-row flex-col-reverse flex-wrap -mx-3 flex'>
                    <div className='w-full lg:w-5/12 px-3 mt-5 lg:mt-0'>
                        <div className='lg:max-w-[421px] lg:ml-auto'>
                            <span className='flex justify-center lg:justify-start -mt-2.5' data-aos="zoom-in"><LogoDesignIcon /></span>
                            <p className='font-poppins font-semibold text-lg sm:text-xl md:text-2xl !leading-[150%] text-white text-center lg:text-start' data-aos="zoom-in">Logo Design</p>
                            <p className='font-poppins font-normal text-base sm:text-lg md:text-xl !leading-[150%] text-white mt-2  text-center lg:text-start opacity-70' data-aos="zoom-in">Logo design is a specialized discipline within the realm of graphic design, focused on creating unique and memorable visual symbols that represent a brand, company, or organization.</p>
                        </div>
                    </div>
                    <div className='lg:w-7/12 w-full px-3 relative z-[2]'>
                        <div className='flex max-w-[547px] w-full justify-center lg:justify-start relative mx-auto lg:ml-auto lg:mr-0 gap-2 sm:gap-[22.88px]'>
                            ...
                            <div className='flex flex-col gap-2 sm:gap-[26.5px] relative z-[2]'>
                                <div className='max-w-[203.39px]' data-aos="zoom-in"><img src={LogoDesign1} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] object-cover w-full max-h-[219.03px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203.39px]' data-aos="zoom-in"><img src={LogoDesign3} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] object-cover w-full max-h-[159px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                            <div className='flex flex-col gap-2 sm:gap-[26.5px] mt-5 sm:mt-10 relative z-[2]'>
                                <div className='max-w-[203.39px] relative' data-aos="zoom-in">
                                ...
                                <div className='max-w-[203.39px]' data-aos="zoom-in"><img src={LogoDesign4} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] object-cover w-full max-h-[159px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='flex-row flex-wrap -mx-3 flex items-center mt-10 sm:mt-16 md:mt-20 lg:mt-24'>
                    <div className='lg:w-7/12 w-full px-3 relative mx-auto lg:mx-0'>
                        <img src={Paypal} alt="paypal" className='max-w-[380px] w-full lg:w-[unset] lg:max-w-[495px] max-h-[529px] mx-auto lg:mx-0 ' data-aos="zoom-in"/>
                    </div>
                    <div className='w-full lg:w-5/12 px-3 mt-5 lg:mt-0'>
                        <div className='lg:max-w-[445px] lg:mr-auto'>
                            <span className='flex justify-center lg:justify-start' data-aos="zoom-in"><SettingIcon /></span>
                            <p className='font-poppins font-semibold text-lg sm:text-xl md:text-2xl !leading-[150%] text-white text-center lg:text-start' data-aos="zoom-in">Strategy & Digital Marketing</p>
                            <p className='font-poppins font-normal text-base sm:text-lg md:text-xl !leading-[150%] text-white mt-2  text-center lg:text-start' data-aos="zoom-in">Strategy in digital marketing is the foundation upon which successful online campaigns are built. It involves setting clear objectives, identifying target audiences.</p>
                        </div>
                    </div>
                </div>
            </div>
