                    ...
                    <div className='lg:w-7/12 w-full px-3 relative z-[2]'>
                        <div className='flex max-w-[547px] w-full justify-center lg:justify-start relative mx-auto lg:ml-auto lg:mr-0 gap-2 sm:gap-[22.88px]'>
                            ...
                            <div className='flex flex-col gap-2 sm:gap-7 relative z-[2]'>
                                <div className='max-w-[203px]'><img src={LogoDesign1} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] object-cover w-full max-h-[219.03px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203px]'><img src={LogoDesign3} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] object-cover w-full max-h-[159px] border-[1px] border-solid duration-300 rounded-[12.52px] border-transparent hover:border-[#4B17E6]' /></div>
                            </div>
                            <div className='flex flex-col gap-2 sm:gap-[26.5px] mt-5 sm:mt-10 relative z-[2]'>
                                <div className='max-w-[203px] relative' >
                                    ...
                                    <img src={LogoDesign2} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] object-cover w-full max-h-[219.03px] border-[1px] border-solid duration-300 rounded-[12.52px] border-transparent hover:border-[#4B17E6]' /></div>
                                <div className='max-w-[203px]' ><img src={LogoDesign4} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] object-cover w-full max-h-[159px] border-[1px] border-solid duration-300 rounded-[12.52px] border-transparent hover:border-[#4B17E6]' /></div>
                            </div>
                        </div>
                    </div>
