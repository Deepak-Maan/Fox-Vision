            ...
            <div className='max-w-[1164px] mx-auto px-3 pt-12 sm:pt-14 md:pt-16 lg:pt-20 xl:pt-60'>
                ...
                <div className='flex pt-14 sm:pt-20 xl:pt-[197px] flex-col-reverse lg:flex-row flex-wrap lg:flex-nowrap -mx-3 relative z-[1] items-center'>
                    ...
                    <div className='w-full lg:w-7/12 px-3 relative mx-auto'>
                        <div className='flex justify-center lg:justify-start gap-2 sm:gap-6'>
                            <div className='flex flex-col gap-2 sm:gap-[26px]'>
                                <div className='max-w-[203px]'><img src={Watch} alt="watch" className='shadow-[0px_17px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[219.03px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203px]'><img src={ModelLady} alt="watch" className='shadow-[0px_17px_42px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[159px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                            <div className='flex flex-col'>
                                <div className=' relative'>
                                    <img src={SmileEmoji} alt="smileEmoji" className=' absolute left-[32%] top-[-28%] max-w-[60px] sm:max-w-[123px] max-h-[123px]' />
                                    <img src={TwoPhone} alt="watch" className=' hover:shadow-[0px_17px_42px_0px_#3B3E430D] max-w-[203px] w-full max-h-[219px] border duration-300 rounded-[13px] hover:border-[#4B17E6] border-transparent' />
                                </div>
                                <div className='max-w-[203px]'><img src={Boodie} alt="watch" className='mt-4 sm:mt-[68.69px] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[150px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                            <div className='flex flex-col gap-2 sm:gap-[25.97px]'>
                                <div className='max-w-[203px]'><img src={Men} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[219.03px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203px]'><img src={Rebio} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[150px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='lg:w-7/12 px-3 relative mx-auto'>
                        <div className='flex gap-2 sm:gap-[22.63px]'>
                            <div className='flex flex-col gap-3 md:gap-7'>
                                <div className='max-w-[203px]'><img src={Joker} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[219.03px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203px]'><img src={BlackMagic} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[159px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                            <div className='flex flex-col gap-3 md:gap-7'>
                                ...
                                <div className='max-w-[203px]'><img src={Strawberry} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[150px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                            <div className='flex flex-col gap-3 md:gap-7'>
                                <div className='max-w-[203px]'><img src={Reptiles} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[219.03px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203px]'><img src={MobilePhone} alt="watch" className='shadow-[0px_16.7px_41.74px_0px_#3B3E430D] hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203px] w-full max-h-[150px] border duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                        </div>
                    </div>
