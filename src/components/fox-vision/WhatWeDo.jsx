                    ...
                    <div className='w-full lg:w-7/12 px-3 relative mx-auto'>
                        <div className='flex justify-center lg:justify-start gap-2 sm:gap-[22.63px]'>
                            <div className='flex flex-col gap-2 sm:gap-[25.97px]'>
                                <div className='max-w-[203.39px]'><img src={Watch} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] w-full max-h-[219.03px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203.39px]'><img src={ModelLady} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] w-full max-h-[159px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                            <div className='flex flex-col'>
                                <div className=' relative'>
                                    <img src={SmileEmoji} alt="smileemoji" className=' absolute left-[32%] top-[-28%] max-w-[60px] sm:max-w-[123px] max-h-[123px]' />
                                    <img src={TwoPhone} alt="watch" className='max-w-[203.39px] w-full max-h-[219.03px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' />
                                </div>
                            ...
                            <div className='flex flex-col gap-2 sm:gap-[25.97px]'>
                                <div className='max-w-[203.39px]'><img src={Men} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] w-full h-full max-h-[219.03px] rounded-[12.52px] border-[1px] border-solid duration-300 hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203.39px]'><img src={Rebio} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] w-full max-h-[150px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='lg:w-7/12 px-3 relative mx-auto'>
                        <div className='flex gap-2 sm:gap-[22.63px]'>
                            <div className='flex flex-col gap-3 md:gap-[26.5px]'>
                                <div className='max-w-[203.39px]'><img src={Joker} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] w-full max-h-[219.03px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                                <div className='max-w-[203.39px]'><img src={BlackMagic} alt="watch" className='hover:shadow-[0px_16.7px_41.74px_0px_#3B3E430D] max-w-[203.39px] w-full max-h-[159px] border-[1px] border-solid duration-300 rounded-[12.52px] hover:border-[#4B17E6] border-transparent' /></div>
                            </div>
                            <div className='flex flex-col gap-3 md:gap-[26.5px]'>
