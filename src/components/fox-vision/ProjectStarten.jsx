    ...
    return (
        <div className={bgColor}>
            <div className='container mx-auto xl:max-w-[1164px] px-3 -mt-10 sm:-mt-1 relative z-[1]'>
                <div className='bg-sky w-full h-[2  00px] sm:h-[253px] rounded-[10px] p-[25px] sm:p-[36px] relative z-[1] translate-y-20 md:translate-y-28'>
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        <Link to="/contact">  <CommonButton
                            className='border border-white hover:!border-transparent w-[124px] !py-[13px] !px-[30px]'
                            btnName='Kontakt'
                        /></Link>
