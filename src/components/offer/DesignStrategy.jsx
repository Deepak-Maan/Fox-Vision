                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className='lg:max-w-[484px] flex flex-col md:flex-row lg:flex-col items-center '>
                        <div>
                            ...
                            <p className='leading-[180%] text-offgrey font-poppins font-normal text-lg sm:text-xl lg:pb-[45px] text-center md:text-start '>Our design process is a <span className=" text-lightlbue">well-thought-out journey</span> that combines innovation, strategy, and collaboration to produce outstanding results.</p>
                        </div>
                        <img className='max-w-[400px] mx-auto max-md:w-full max-lg:w-1/2' src={designImage} alt="designImg" />
                    </div>
                    <div className='pt-10 lg:pt-0'>
                        {designStrategyData.map((data, index) => (
                            <div key={index} className='max-w-[609px] mx-auto py-5 sm:py-[26px] relative mb-8 sm:mb-[50px] lg:max-h-[150px] xl:min-w-[609px] shadow-[0_4px_27px_0px_#4B17E614] flex'>
                                <div className="absolute left-[-20px] sm:left-[-23px] top-0 z-1"><OfferArrowLayer /></div>
                                <div className='flex items-center lg:items-end pr-[45px] sm:pr-[87px]'>
